                                ...
                                if queued[message.guild.id] and queued[message.guild.id][1] and queued[message.guild.id][1].dl == 1 then
                                    ...
                                    if queued[message.guild.id][1].stream ~= nil then
                                        if message.guild.connection then
                                            difference = time.fromMilliseconds(message.guild.connection:playFFmpeg(queued[message.guild.id][1].stream)):toSeconds() - queued[message.guild.id][1].raw_duration
